...
pub fn run() {
    ...
    use crate::tauri_adapter::commands::{
        ...
        list_target_groups, load_preferences, open_skill_directory, pin_skill_updates,
        plan_abandon, plan_adopt, plan_create_agent_configuration, plan_delete_agent_configuration,
