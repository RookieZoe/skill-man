...
/// Parent — ticket #48; v7: Git Repository Source releases — ticket #63;
/// v9: Git namespace, tracking policy and immutable member — ticket #91).
pub const CURRENT_CATALOG_SCHEMA_VERSION: u32 = 9;
