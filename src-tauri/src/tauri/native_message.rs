...
impl NativeMessageKey {
    fn catalog_key(self) -> &'static str {
        match self {
            Self::UpdateDone => "library.preferences.done",
            Self::UpdateChecking => "library.preferences.checking",
            Self::UpdateCurrent => "library.preferences.up_to_date",
            Self::UpdateDownloading => "library.app_update.downloading",
            Self::UpdateReady => "library.app_update.ready",
            Self::UpdateGatekeeper => "library.app_update.gatekeeper",
            Self::UpdateDownload => "library.app_update.download_update",
            Self::UpdateInstall => "library.app_update.install_restart",
            Self::UpdateLater => "library.app_update.later",
            Self::UpdateManualDownload => "library.app_update.manual_download",
            Self::UpdateUnsupported => "library.app_update.unsupported",
            Self::UpdateSourceFailed => "app.update_error.source_unavailable",
            Self::UpdateStateFailed => "app.update_error.state_unavailable",
            Self::UpdateStale => "app.update_error.stale_update",
            Self::UpdateDownloadFailed => "app.update_error.download_failed",
            Self::UpdateInstallFailed => "app.update_error.install_failed",
            Self::UpdateFailed => "app.update_error.generic",
            Self::UpdateOffer => "app.update.native_offer",
            Self::Feedback => "tray.feedback",
            Self::FeedbackFailed => "tray.feedback_failed",
            Self::AboutCredits => "app.about.credits",
            Self::TrayAbout => "tray.about",
            Self::Language => "language.label",
            Self::FollowSystem => "appearance.system",
            Self::Chinese => "language.zh_hans",
            Self::English => "language.english",
            Self::Appearance => "appearance.title",
            Self::Light => "appearance.light",
            Self::Dark => "appearance.dark",
            Self::CheckUpdate => "tray.check_update",
            Self::LocaleFailed => "error.locale_store_unavailable",
            Self::AppearanceFailed => "appearance.failed",
...
mod tests {
    ...
    fn every_native_key_resolves_in_both_locales() {
        for locale in [EffectiveLocale::En, EffectiveLocale::ZhHans] {
            for key in [
                NativeMessageKey::UpdateChecking,
                NativeMessageKey::UpdateCurrent,
                NativeMessageKey::UpdateDownloading,
                NativeMessageKey::UpdateReady,
                NativeMessageKey::UpdateGatekeeper,
                NativeMessageKey::UpdateDownload,
                NativeMessageKey::UpdateInstall,
                NativeMessageKey::UpdateLater,
                NativeMessageKey::UpdateManualDownload,
                NativeMessageKey::UpdateUnsupported,
                NativeMessageKey::UpdateSourceFailed,
                NativeMessageKey::UpdateStateFailed,
                NativeMessageKey::UpdateStale,
                NativeMessageKey::UpdateDownloadFailed,
                NativeMessageKey::UpdateInstallFailed,
                NativeMessageKey::UpdateFailed,
                NativeMessageKey::UpdateOffer,
                NativeMessageKey::Feedback,
                NativeMessageKey::FeedbackFailed,
                NativeMessageKey::AboutCredits,
                NativeMessageKey::TrayAbout,
                NativeMessageKey::Language,
                NativeMessageKey::FollowSystem,
                NativeMessageKey::Chinese,
                NativeMessageKey::English,
                NativeMessageKey::Appearance,
                NativeMessageKey::Light,
                NativeMessageKey::Dark,
                NativeMessageKey::CheckUpdate,
                NativeMessageKey::LocaleFailed,
                NativeMessageKey::AppearanceFailed,
                ...
                NativeMessageKey::TrayHealthMismatch,
                NativeMessageKey::SourceSnapshotMismatch,
                NativeMessageKey::MenuEdit,
