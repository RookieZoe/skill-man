...
fn source_capability_report_serializes_closed_source_states() {
    ...
    assert_eq!(
        ...
        r#"{"sources":[{"remoteId":"healthy","canonicalUrl":"https://github.com/acme/skills","kind":"git_repository_source"},{"remoteId":"legacy","canonicalUrl":"https://github.com/acme/legacy","kind":"legacy_per_skill_git_state"},{"remoteId":"conflicted","canonicalUrl":"https://github.com/acme/conflicted","kind":"remote_source_identity_conflict"}]}"#
    );
}
