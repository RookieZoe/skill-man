...
先发布并手动安装带同一公钥的基线版，再按相同步骤发布版本严格递增、数据兼容的目标版。2026-09-12 已完成 v0.1.2 → v0.1.3 → v0.1.2 的指定 VM 环境验收，详见[社区 App Update 原生验收记录](app-update-native-verification.md)，包括正式升级链、受控损坏包测试及结论边界。
